...
bot = lightbulb.BotApp(token=os.getenv('TOKEN'), prefix=os.getenv('PREFIX'), banner=None, default_enabled_guilds=(802249775201910834), intents=hikari.Intents.ALL_UNPRIVILEGED)
miru.install(bot)
